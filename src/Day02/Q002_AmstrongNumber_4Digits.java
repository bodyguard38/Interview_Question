...
public class Q002_AmstrongNumber_4Digits {
    ...
    Armstrong sayi:herhangi bir sayinin rakamlarinin kupleri toplami o sayiyi veriyorsa sayi  Armstrong sayidir
     ...
     public static void main(String[] args) {
         ...
         String strSayi = scanner.nextLine();
    ...
    private static void amstrongCheck(int sayi) {
         ...
         int ilkSayi = Integer.parseInt(strSayi);
         int ustlerToplami=0;
         ...
         if(ustlerToplami == ilkSayi){
             System.out.println(strSayi + " sayi amstrong");
         }else{
           //  System.out.println(strSayi + " sayi not amstrong");
         }
    }
}
